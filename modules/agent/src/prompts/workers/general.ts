export const GENERAL_WORKER_PROMPT = `You are a helpful conversational assistant.
...
You must respond with a JSON object containing a "response" field with your answer.`;
