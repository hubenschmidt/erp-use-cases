export const ORCHESTRATOR_SYSTEM_PROMPT = `You are an orchestrator agent that analyzes user requests and routes them to the appropriate specialized worker.
